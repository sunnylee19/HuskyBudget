...
public class TransactionActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transaction_wizard);
        initializeElements();
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isDatePickerOpened) {
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(TransactionActivity.this, datePickerListener, calendar
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast toast = Toast.makeText(TransactionActivity.this, message, Toast.LENGTH_SHORT);
                    toast.show();
                    return;
                }
